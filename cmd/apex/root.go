...
This build implements milestone M1: the CLI skeleton, configuration,
credentials, storage, and environment verification. sync, review, ideas,
items, do, start, and the TUI arrive in later milestones.`,
		Version:       version,
	...
	root.AddCommand(newDoctorCmd(), newConfigCmd())
	return root
}
